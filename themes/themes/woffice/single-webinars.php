...
$edit_allowed           = (Woffice_Frontend::edit_allowed('webinars') == true) ? true : false;
$delete_allowed         = (Woffice_Frontend::edit_allowed('webinars', 'delete') == true) ? true : false;
if ($edit_allowed) {
	$process_result = Woffice_Frontend::frontend_process('webinars', $post->ID);
}
						...
						if ($edit_allowed || $delete_allowed) { ?>
							...
							<div class="frontend-wrapper box">
								<div class="intern-padding frontend-wrapper">
                                    ...
                                    <?php if($edit_allowed) : ?>
                                        <?php Woffice_Frontend::frontend_render('webinars', $process_result, get_the_ID()); ?>
                                    <?php endif; ?>
