/**
 * Viewmodel of the dialog for delete association.
 *
 * Requires the 'types-delete-association-related-content-dialog' assets to be present.
 *
 ...
 * @since 2.3
 */
Types.page.extension.relatedContent.viewmodels.DeleteDialogViewModel = function(closeCallback) {
	...
	self.display = function() {
		...
		var dialog = Types.page.extension.relatedContent.main.createDialog(
			...
			[
				{
					text: Types.page.extension.relatedContent.strings.button['delete'],
					click: function() {
						cleanup(dialog);
						closeCallback(true);
					},
