	...
	<!-- START CONTENT -->
			...
			<form id="featured_upload" method="POST" action="<?php echo get_site_url('','wp-content/plugins/courses-maker/save-lessons.php'); ?>" style="display: flex; flex-direction: column; min-width: 100%;">
				<div class="add-header">
					<h1><input id="add_title" name="add_title" title="Quiz Title" type="text" autocomplete="on"  placeholder="Quiz Title"></h1>
				</div>
...
<h2 class="hndle ui-sortable-handle"><span>Quiz Settings</span></h2>
<div class="inside">
